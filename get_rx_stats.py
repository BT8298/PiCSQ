...
# temporary deregistration for testing
with modem.ser:
    modem.AT_query("AT+COPS=2")
...
with modem.ser:
    ...
    if m:
        ...
        raise RuntimeWarning("Modem is not registered with an operator (or it is in GSM mode).")
        operator_alphanumeric_name = "NA"
        lte_ue_category = "NA"
